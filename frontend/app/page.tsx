        ...
        <Card className="lg:col-span-1">
          ...
          <CardContent className="space-y-3">
            <Link href="/campaigns" className="block">
              <button className="flex w-full items-center gap-3 rounded-lg border border-gray-200 p-4 text-left transition-colors hover:bg-gray-50">
              ...
              {mockRecentActivity.map((activity) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <Badge
                      variant="status"
                      status={activity.status === 'success' ? 'approved' : 'pending'}
                    >
                      {activity.status}
                    </Badge>
