...
export default function AnalyticsPage() {
  ...
  const chartMax = Math.max(...mockDailyStats.map((d) => d[selectedMetric as keyof typeof d] as number));
    ...
    <div className="p-8">
      ...
      <div className="mb-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard
          ...
          change={mockOverviewData.viewsChange}
          icon={Eye}
          iconColor="bg-blue-100 text-blue-600"
        />
        <StatCard
          title="Total Likes"
          value={mockOverviewData.totalLikes}
          change={mockOverviewData.likesChange}
          icon={Heart}
          iconColor="bg-red-100 text-red-600"
        />
        <StatCard
          title="Total Comments"
          value={mockOverviewData.totalComments}
          change={mockOverviewData.commentsChange}
          icon={MessageCircle}
          iconColor="bg-green-100 text-green-600"
        />
        <StatCard
          title="Total Shares"
          value={mockOverviewData.totalShares}
          change={mockOverviewData.sharesChange}
          icon={Share2}
                  ...
                  return (
                    ...
                    >
                      <div className="relative w-full flex-1">
                        <div
                          className="absolute bottom-0 w-full rounded-t-lg bg-blue-500 transition-all group-hover:bg-blue-600"
                          style={{ height: `${height}%` }}
                        />
                        {/* Tooltip */}
              ...
              <div className="relative h-40 w-40">
                <svg className="h-full w-full -rotate-90" viewBox="0 0 100 100">
                  ...
                  <circle
                    ...
                    strokeWidth="10"
                    strokeLinecap="round"
                    strokeDasharray={`${mockOverviewData.engagementRate * 28.27} 282.7`}
                  />
                </svg>
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-3xl font-bold text-gray-900">
                    {mockOverviewData.engagementRate}%
                  </span>
              ...
              <div className="mt-6 w-full space-y-3">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium text-green-600">
                    +{(mockOverviewData.engagementRate - 4.5).toFixed(1)}% above
                  </span>
                </div>
              </div>
            </div>
                ...
                {mockPlatformStats.map((platform) => (
                  <tr key={platform.platform} className="group hover:bg-gray-50">
                    <td className="py-4">
                      <div className="flex items-center gap-3">
                        <span
                          className={`flex h-8 w-8 items-center justify-center rounded-lg text-lg ${getPlatformColor(
                            platform.platform
                          )}`}
                        >
